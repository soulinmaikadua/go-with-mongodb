...
type UserModel struct {
	...
	MainBalance   float32            `json:"main_balance" bson:"main_balance"`
	DemoBalance   float32            `json:"demo_balance" bson:"dem_balance"`
	LiveBalance   float32            `json:"live_balance" bson:"live_balance"`
